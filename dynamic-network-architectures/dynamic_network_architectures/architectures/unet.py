...
class ResidualEncoderUNet(AbstractDynamicNetworkArchitectures):
    ...
    def forward(self, x):
        ...
        # 使用np.save保存
        file_path = "sdf_feature_nnunet/skip1_before.npy"
        ...
        # 使用np.save保存
        file_path = "sdf_feature_nnunet/skip2_before.npy"
        ...
        # 使用np.save保存
        file_path = "sdf_feature_nnunet/skip3_before.npy"
        ...
        # 使用np.save保存
        file_path = "sdf_feature_nnunet/skip4_before.npy"
